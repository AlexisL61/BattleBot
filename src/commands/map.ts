...
async function mainType(message:Message,thisPlayer:Player){
    ...
    const messageSent = await message.edit({embeds:[await EmbedConstructor.mapEmbed(thisPlayer,attackablePlayers)],components:ComponentsConstructor.mapComponents()})
