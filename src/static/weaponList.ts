...
[
    ...
    {"id":"arc","name":{"fr":"arc","en":"bow"},"image":"","emoji":"🏹","effect":new Mention({"child":(new Group({"children":[new Damage({"damage":10,"mention":"nearestMention","miss":3,"critical":3})],"groupTarget":"SAME_TARGET"})),"toMention":"La personne à attaquer"}),"rarity":"common"},
